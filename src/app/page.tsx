    ...
    <>
      <div>
        ...
        <nav className="flex justify-evenly items-center mx-36 bg-white">
          <Link href={""} className="mt-5 mb-5 mr-80">
            <Image src={logo} width={150} height={50} alt="logo" />
          </Link>
          <ul className="flex justify-center items-center space-x-6 font-medium">
            <Link href={"/"} className="hover:text-deep-orange">
              Home
            </Link>
            <Link href={"/"} className="hover:text-deep-orange">
              About Us
          ...
          <button className="w-28 py-2 bg-deep-orange rounded font-semibold text-white">
            Login
          </button>
        </nav>
        {/* ----Navbar End---- */}
        ...
        <section className="h-screen bg-[url('./background-image.png')] bg-cover bg-no-repeat flex flex-col justify-center items-center">
          <div className="mx-80">
            <h1 className="font-extrabold text-6xl text-white mb-8">
              WELCOME TO KEPLER
            </h1>
            <p className="font-medium text-lg text-white">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore
              ullam repudiandae obcaecati magni veritatis totam, ab minima in
              neque incidunt nemo iure quaerat aliquam voluptates autem rem
              laudantium blanditiis voluptas sunt ratione ipsam harum eligendi
              odit at. Aut illum minima facilis soluta, numquam aliquid
              consectetur nobis qui deserunt vel et nulla nesciunt itaque rerum,
              culpa laboriosam, officiis quibusdam iure sequi.
            </p>
            <button className="mt-9 px-12 py-3 bg-deep-orange rounded-full font-bold text-white">
              JOIN US NOW!
            </button>
          </div>
          {/* Course Category */}
          <section className="grid grid-cols-3 mx-36 gap-24 mt-16">
            <div className="py-8 px-16 bg-orange shadow-xl text-center flex flex-col justify-center items-center">
              ...
              <p className="text-white">
                Select from out tailor made courses for your academic and
                professional needs
              </p>
            </div>
            <div className="py-8 px-16 bg-orange shadow-xl text-center flex flex-col justify-center items-center">
        ...
        <section className="bg-cyan-blue">
          <div className="mx-36">
            <h1 className="font-extrabold text-5xl pt-28">
              Explore Top Courses
            </h1>
            <div className="flex flex-col justify-center items-center">
              ...
              <button className="px-6 mt-20 mb-20 bg-orange text-white font-medium py-2 rounded-md">
        ...
        <section className="mx-36 mb-36">
          <h1 className="font-extrabold text-5xl mt-32 mb-20">
            Upcoming Events
          </h1>
          <div className="bg-cyan-blue h-96 border-4 flex justify-center items-center">
            ...
            <div className="text-center">
              ...
              <p>
                Date: 18 June, Sunday Time: 3:30 PM Location: Mentors' Kalabagan
                Branch
              </p>
              <button className="text-white bg-orange py-2 px-5 rounded-sm font-bold mt-9">
                Read More
              </button>
            </div>
          </div>
          ...
          <div className="mx-44 text-white flex justify-between">
            <div>
              ...
              <h1 className="font-bold">
                Accelerate your career with job-rady digital skills
              </h1>
            </div>
        ...
        <section className="mb-32 bg-cyan-blue">
          <div className="mx-36">
            <h1 className="font-extrabold text-5xl mt-32 mb-20 text-center">
              Testimonials
            </h1>
            <section className="grid grid-cols-3 gap-52">
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="text-center">
                  “Dataque has helped me expand my knowledge through serveral
        ...
        <footer className="  bg-footer-color">
          <div className="flex flex-row mx-4 py-4">
            ...
            <div className=" basis-1/3 grid-cols-4 text-white pt-6">
              ...
              />
              <button className=" bg-deep-orange rounded font-semibold text-white block my-2 px-5 py-1">
                Subscribe
              </button>
